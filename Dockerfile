...
LABEL org.opencontainers.image.description="Download Landsat images for AK-FIRE-SAFE"
LABEL org.opencontainers.image.vendor="Alaska Satellite Facility"
LABEL org.opencontainers.image.authors="mfangaritav <mf.angarita52@gmail.com>"
